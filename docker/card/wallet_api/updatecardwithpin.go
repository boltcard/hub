...
func UpdateCardWithPin(w http.ResponseWriter, r *http.Request) {
	...
	if reqObj.CardPinNumber == "" {
		db.Db_update_card_without_pin(card_id, tx_limit_sats, day_limit_sats, pin_enable, pin_limit_sats, lnurlw_enable)
	} else {
		db.Db_update_card_with_pin(card_id, tx_limit_sats, day_limit_sats, pin_enable, reqObj.CardPinNumber, pin_limit_sats, lnurlw_enable)
	}
